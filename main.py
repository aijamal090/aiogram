...
#def start(update: Update, context: CallbackContext) -> None:
 #   update.message.reply_text('Я загадал число от 1 до 3. Угадайте!')
...
#def guess_number(update: Update, context: CallbackContext) -> None:
    ...
    #try:
       ...
       #     update.message.reply_text("Правильно, вы отгадали!")
      #      update.message.reply_photo('https://media.makeameme.org/created/you-win-nothing-b744e1771f.jpg')
     #   else:
    #        update.message.reply_text("Неправильно, попробуйте снова.")
   #         update.message.reply_photo('https://media.makeameme.org/created/sorry-you-lose.jpg')
  #  except ValueError:
 #       update.message.reply_text("Пожалуйста, введите число от 1 до 3.")
